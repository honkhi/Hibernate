...
public class DlgChonNhaCungCap extends javax.swing.JDialog {
    ...
    private void btnChonNCCActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnChonNCCActionPerformed
    ...
    private void btnSuaNCCActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnSuaNCCActionPerformed
        int row = tblNhaCungCap.getSelectedRow();
        if (row < 0) {
            new MyDialog("Ủa chưa chọn kìa!", MyDialog.ERROR_DIALOG);
            return;
