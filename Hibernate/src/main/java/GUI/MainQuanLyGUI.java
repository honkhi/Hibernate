...
public class MainQuanLyGUI extends JFrame {
    ...
    public MainQuanLyGUI() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    private void addControls() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        ...
        btnDoiMatKhau = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/icons8_gear_46px.png"));
        ...
        JLabel lblTitleText = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/title-text.png"));
        lblTitleText.setBounds(width / 2 - 428 / 2, 3, 428, 38);
        pnTitle.add(lblTitleText);

        btnMinimize = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/btn-minimize.png"));
        btnMinimize.setBounds(width - 85, 5, 38, 35);
        btnMinimize.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        pnTitle.add(btnMinimize);

        btnClose = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/btn-close.png"));
        ...
        JLabel lblAvatar = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/avatar.png"), JLabel.CENTER);
        lblAvatar.setPreferredSize(new Dimension(250, 210));
        pnMenuLeft.add(lblAvatar);

        lblBanHang = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblBanHang.png"));
        lblKhuyenMai = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblKhuyenMai.png"));
        lblNhapHang = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblNhapHang.png"));
        lblSanPham = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblSanPham.png"));
        lblNhanVien = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblNhanVien.png"));
        lblKhachHang = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblKhachHang.png"));
        lblThongKe = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/lblThongKe.png"));
        ...
        //==========ADD PANEL B�?N HÀNG + KHUYẾN MÃI (Ko phân quy�?n)==========
    ...
    private void addEvents() {
        ...
        btnMinimize.addMouseListener(new MouseListener() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                btnMinimize.setIcon(new ImageIcon("src/main/resources/image/ManagerUI/btn-minimize--hover.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnMinimize.setIcon(new ImageIcon("src/main/resources/image/ManagerUI/btn-minimize.png"));
            }
        });
        ...
        btnClose.addMouseListener(new MouseListener() {
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                btnClose.setIcon(new ImageIcon("src/main/resources/image/ManagerUI/btn-close--hover.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnClose.setIcon(new ImageIcon("src/main/resources/image/ManagerUI/btn-close.png"));
            }
        });

        for (final JLabel lbl : listMenuLeft) {
    ...
    private void thoatChuongTrinh() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
