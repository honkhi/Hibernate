...
public class DlgQuanLyLoai extends javax.swing.JDialog {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnThemActionPerformed
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnXoaActionPerformed
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnSuaActionPerformed
        String ma = txtMaLoai.getText();
