...
public class DlgQuyen_MatKhau extends javax.swing.JDialog {
    ...
    public DlgQuyen_MatKhau(String maNV) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        this.maNV = maNV;
        initComponents();
    ...
    private void loadDataCmbQuyen() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    private void btnLuuQuyenActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnLuuQuyenActionPerformed
