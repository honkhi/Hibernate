...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    public PnQuanLyBanHangGUI() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        changLNF("Windows");
        addControlsBanHang();
        addEventsBanHang();
    }
    ...
    private void addControlsBanHang() {
        ...
        //<editor-fold defaultstate="collapsed" desc="Bảng gi�? hàng">
        ...
        for (final JLabel lbl : btnSPList) {
            lbl.setFont(font);
            lbl.setForeground(Color.white);
            lbl.setIcon(new ImageIcon("src/main/resources/image/ManagerUI/btn-BanHang.png"));
            ...
            lbl.addMouseListener(new MouseListener() {
                ...
                public void mouseEntered(MouseEvent e) {
                    lbl.setIcon(new ImageIcon("src/main/resources/image/ManagerUI/btn-BanHang--hover.png"));
                }
        ...
        JLabel lblTitleHoaDon = new JLabel("THÔNG TIN HÓA ĐƠN");
        lblTitleHoaDon.setFont(new Font("Tahoma", Font.BOLD, 28));
        btnResetHoaDon = new JButton(new ImageIcon("src/main/resources/image/Refresh-icon.png"));
        ...
        JLabel lblTitleCTHD = new JLabel("CHI TIẾT HÓA ĐƠN");
        JPanel pnTitleCT = new TransparentPanel();
        lblTitleCTHD.setFont(new Font("Tahoma", Font.BOLD, 28));

        btnResetCTHoaDon = new JButton(new ImageIcon("src/main/resources/image/Refresh-icon.png"));
    ...
    private void xuLyClickTblBanHang() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    private ImageIcon getAnhSP(String src) {
        ...
        File fileImg = new File("src/main/resources/image/SanPham/" + src);
        ...
        try {
            ...
            fileAnhSP = new File("src/main/resources/image/SanPham/" + src);
        } catch (IOException e) {
            fileAnhSP = new File("src/main/resources/image/SanPham/default.png");
        }
    ...
    private void xuLyThemVaoGioHang() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        int row = tblBanHang.getSelectedRow();
        if (row < 0) {
            return;
        }
    ...
    private void xuLyHienCTHoaDon() {
        ...
        // G�?i hiển thị data trên tblCTHoaDon
