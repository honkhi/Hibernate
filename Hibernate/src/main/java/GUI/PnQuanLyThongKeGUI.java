...
public class PnQuanLyThongKeGUI extends JPanel {
    ...
    public PnQuanLyThongKeGUI() throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        changLNF("Windows");
        addControls();
        addEvents();
    }
    ...
    private void addControls() {
        ...
        btnView = new JButton(new ImageIcon("src/main/resources/image/icons8_view_40px.png"));
        lblBackgroundThucDon = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/thongKeMon.png"));
        lblBackgroundKhachHang = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/thongKeKhachHang.png"));
        lblBackgroundNhanVien = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/thongKeNhanVien.png"));
        lblBackgroundDoanhThu = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/thongKeDoanhThu.png"));
...
//        pnThongKeTong.add(btn_filter);
        ...
        JLabel lblBackgroundBang = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/bangThongKe.png"));
        ...
        // ==============================================
        //              THï¿½?NG KÃŠ CHI TIáº¾T
        // ==============================================
        pnThongKeChiTiet = new TransparentPanel(null);

        btnBack = new JButton(new ImageIcon("src/main/resources/image/icons8_undo_40px.png"));
        btnBack.setToolTipText("Quay lại");
        btnBack.setBounds(10, 10, 45, 45);
        pnThongKeChiTiet.add(btnBack);

        JLabel lblBackGroundBangChiTiet = new JLabel(new ImageIcon("src/main/resources/image/ManagerUI/bangChiTiet.png"));
