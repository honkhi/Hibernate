...
public class XuatPhieuNhapGUI extends javax.swing.JDialog {
    ...
    public XuatPhieuNhapGUI(String nhaCungCap, String nhanVien, ArrayList<CTPhieuNhap> listCTPhieuNhap) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        hd += "<td style='text-align:center;'>" + "</td>";
        hd += "<td style='text-align:center;font-weight:bold'>Thành ti�?n</td>";
