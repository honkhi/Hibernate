...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnResetKho.setIcon(new javax.swing.ImageIcon("src/main/resources/image/ManagerUI/Refresh-icon.png")); // NOI18N
        ...
        jLabel2.setText("Hàng chưa nhập");
        jPanel3.add(jLabel2);
    ...
    private void loadDataTablePhieuNhapTheoGia(String giaThap, String giaCao) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        phieuNhapBUS.docDanhSach();
        ArrayList<PhieuNhap> dspn = phieuNhapBUS.getListPhieuNhapTheoGia(giaThap, giaCao);
        duaDataVaoTablePhieuNhap(dspn);
    }

    private void loadDataTablePhieuNhapTheoNgay(String tuNgay, String denNgay) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {
        phieuNhapBUS.docDanhSach();
    ...
    private void btnThemVaoGioActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnThemVaoGioActionPerformed
        int soLuong = 0;
        int donGia = 0;
        try {
    ...
    private void btnXoaKhoiGioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaKhoiGioActionPerformed
        ...
        if (row > -1) {
            ...
            try {
				new MyDialog("Chưa chon sao xoá :)", MyDialog.ERROR_DIALOG);
			} catch (InstantiationException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			} catch (IllegalAccessException e) {
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        if (nhaCungCap.equals("")) {
            try {
				new MyDialog("Hãy chon nhà cung cấp!", MyDialog.ERROR_DIALOG);
			} catch (InstantiationException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			} catch (IllegalAccessException e) {
        ...
        ArrayList<CTPhieuNhap> dsct = new ArrayList<CTPhieuNhap>();
        for (int i = 0; i < row; i++) {
    ...
    private void txtGiaCaoActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_txtGiaCaoActionPerformed
    ...
    private void txtDenNgayActionPerformed(java.awt.event.ActionEvent evt) throws InstantiationException, IllegalAccessException, UnsupportedLookAndFeelException {//GEN-FIRST:event_txtDenNgayActionPerformed
